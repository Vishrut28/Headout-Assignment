...
# This creates an Elastic Load Balancer and supporting infrastructure
...
# Local values
locals {
  name_prefix = "java-app-${var.environment}"
  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        {
          ...
          valueFrom = aws_secretsmanager_secret.ssh_key.arn
        }
      ]
      ...
      healthCheck = {
        command = ["CMD-SHELL", "/app/health-check.sh"]
        interval = 30
        timeout = 5
        retries = 3
        startPeriod = 60
